...
本文件复制到 `.codestable/roadmap/agent-onboarding-registry-convergence/goal-protocol.md` 后，由 `/goal` 会话读取。它描述如何按一个已确认的 roadmap 执行包，逐个完成 feature 的实现、代码审查、QA 验证与验收。

## 先读文件

进入 goal 会话后先读取：

- `.codestable/roadmap/agent-onboarding-registry-convergence/goal-state.yaml`
- `.codestable/roadmap/agent-onboarding-registry-convergence/goal-plan.md`
- `.codestable/roadmap/agent-onboarding-registry-convergence/agent-onboarding-registry-convergence-roadmap.md`
- `.codestable/roadmap/agent-onboarding-registry-convergence/agent-onboarding-registry-convergence-items.yaml`
- `.codestable/roadmap/agent-onboarding-registry-convergence/goal-features/*.md`
...
Plan: .codestable/roadmap/agent-onboarding-registry-convergence/goal-plan.md
Protocol: .codestable/roadmap/agent-onboarding-registry-convergence/goal-protocol.md
```
...
```text
.codestable/roadmap/agent-onboarding-registry-convergence/goal-features/<feature-slug>-repair.md
```
...
最后一个 feature accepted 后，不能直接完成。必须生成 `.codestable/roadmap/agent-onboarding-registry-convergence/goal-audit.md`，并在 transcript 中打印审计摘要。最终审计是 roadmap 级 gate，不是把每个 feature 的 QA/acceptance 摘要拼起来。
...
把审计结果写入 `.codestable/roadmap/agent-onboarding-registry-convergence/goal-audit.md`：
...
# agent-onboarding-registry-convergence Goal 最终审计
...
Coverage: <re-verified> re-verified / <trust-prior> trust-prior
Audit report: .codestable/roadmap/agent-onboarding-registry-convergence/goal-audit.md
```

如果有缺口：

1. 写 `.codestable/roadmap/agent-onboarding-registry-convergence/audit-repair-<round>.md`。
2. 只修审计失败项，不扩大范围。
3. 重跑审计。
