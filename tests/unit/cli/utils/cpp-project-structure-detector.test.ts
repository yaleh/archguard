...
describe('getCppTopLevelModules', () => {
  ...
  it('returns sorted list of dirs that contain C++ files (meeting threshold)', async () => {
    root = await makeTempTree({
      ...
      'tests/a.cpp': '', 'tests/b.cpp': '', 'tests/c.cpp': '', 'tests/d.cpp': '', 'tests/e.cpp': '',
      'docs/README.md': '',
    });
  ...
  it('skips build/ directory', async () => {
    root = await makeTempTree({
      'build/a.cpp': '', 'build/b.cpp': '', 'build/c.cpp': '', 'build/d.cpp': '', 'build/e.cpp': '',
      'src/a.cpp': '', 'src/b.cpp': '', 'src/c.cpp': '', 'src/d.cpp': '', 'src/e.cpp': '',
    });
  ...
  it('skips vendor/ directory', async () => {
    root = await makeTempTree({
      'vendor/a.cpp': '', 'vendor/b.cpp': '', 'vendor/c.cpp': '', 'vendor/d.cpp': '', 'vendor/e.cpp': '',
      'src/a.cpp': '', 'src/b.cpp': '', 'src/c.cpp': '', 'src/d.cpp': '', 'src/e.cpp': '',
    });
    expect(await getCppTopLevelModules(root)).toEqual(['src']);
  });
  ...
  it('skips cmake-build-release/ (prefix match, not exact)', async () => {
    root = await makeTempTree({
      'cmake-build-release/a.cpp': '', 'cmake-build-release/b.cpp': '', 'cmake-build-release/c.cpp': '',
      'cmake-build-release/d.cpp': '', 'cmake-build-release/e.cpp': '',
      'cmake-build-relwithdebinfo/a.cpp': '', 'cmake-build-relwithdebinfo/b.cpp': '',
      'cmake-build-relwithdebinfo/c.cpp': '', 'cmake-build-relwithdebinfo/d.cpp': '',
  ...
  it('skips hidden directories (starting with dot)', async () => {
    root = await makeTempTree({
      '.cache/a.cpp': '', '.cache/b.cpp': '', '.cache/c.cpp': '', '.cache/d.cpp': '', '.cache/e.cpp': '',
      'src/a.cpp': '', 'src/b.cpp': '', 'src/c.cpp': '', 'src/d.cpp': '', 'src/e.cpp': '',
    });
    expect(await getCppTopLevelModules(root)).toEqual(['src']);
  });
  ...
  it('returns sorted alphabetically', async () => {
    root = await makeTempTree({
      'zzz/a.cpp': '', 'zzz/b.cpp': '', 'zzz/c.cpp': '', 'zzz/d.cpp': '', 'zzz/e.cpp': '',
      'aaa/a.cpp': '', 'aaa/b.cpp': '', 'aaa/c.cpp': '', 'aaa/d.cpp': '', 'aaa/e.cpp': '',
      'mmm/a.cpp': '', 'mmm/b.cpp': '', 'mmm/c.cpp': '', 'mmm/d.cpp': '', 'mmm/e.cpp': '',
    });
...
describe('getCppTopLevelModules min file threshold', () => {
  let root: string;
  afterEach(async () => { if (root) await fs.remove(root); });
  ...
  it('excludes module with fewer than MIN_CPP_FILES_FOR_MODULE files', async () => {
    root = await makeTempTree({
      'tiny/x.cpp': '', 'tiny/y.cpp': '',  // only 2 files — below threshold
    });
    expect(await getCppTopLevelModules(root)).toEqual([]);
  });
  ...
  it('excludes module with 4 files (one below threshold)', async () => {
    root = await makeTempTree({
      'small/a.cpp': '', 'small/b.cpp': '', 'small/c.cpp': '', 'small/d.cpp': '',
    });
    expect(await getCppTopLevelModules(root)).toEqual([]);
  });
});
...
describe('detectCppProjectStructure', () => {
  ...
  it('returns package + class + N class/<dir> for N subdirs meeting threshold', async () => {
    root = await makeTempTree({
      'engine/a.cpp': '', 'engine/b.cpp': '', 'engine/c.cpp': '', 'engine/d.cpp': '', 'engine/e.cpp': '',
      'common/a.cpp': '', 'common/b.cpp': '', 'common/c.cpp': '', 'common/d.cpp': '', 'common/e.cpp': '',
    });
    ...
    expect(result[0]).toMatchObject({ name: 'game/overview/package', level: 'package', language: 'cpp' });
    expect(result[1]).toMatchObject({ name: 'game/class/all-classes', level: 'class',   language: 'cpp' });
  ...
  it('all DiagramConfigs carry language: cpp', async () => {
    root = await makeTempTree({
      'src/a.cpp': '', 'src/b.cpp': '', 'src/c.cpp': '', 'src/d.cpp': '', 'src/e.cpp': '',
      'lib/a.cpp': '', 'lib/b.cpp': '', 'lib/c.cpp': '', 'lib/d.cpp': '', 'lib/e.cpp': '',
    });
    const result = await detectCppProjectStructure(root, 'proj');
    expect(result.every(d => d.language === 'cpp')).toBe(true);
  });
