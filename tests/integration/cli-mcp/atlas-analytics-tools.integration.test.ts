...
describe.skipIf(!hasAtlasData)(
  'Atlas analytics MCP tools — integration (meta-cc Go project)',
  () => {
    let client: Client;
    let _clientTransport: ReturnType<typeof InMemoryTransport.createLinkedPair>[0];
