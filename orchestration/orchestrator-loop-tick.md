...
> - `orchestration/orchestrator-loop-tick.md` / `docs/analysis/fast-mode-loop-tick.md`（本文件的
...
```
Monitor({command: "/home/yale/work/archguard/plugin/scripts/inner-state.sh",
