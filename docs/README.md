...
- [Specifications](dev-guide/specs.md)
- [Plugin Development Guide](dev-guide/plugin-development-guide.md)
- [ArchJSON Levels](dev-guide/archjson-levels.md)
...
Design proposals under active consideration:
...
See [Documentation Contributing Guide](CONTRIBUTING.md) for how to add and organize documentation.

## Archive

Historical proposals, plans, and reports are in [archive/](archive/).
