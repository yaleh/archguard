...
- **AI-Powered Diagrams**: Beautiful PlantUML diagrams generated by Claude Sonnet
...
- `ANTHROPIC_API_KEY` - Your Anthropic API key (required for PlantUML generation)
...
4. **Generate**: ArchJSON → Claude AI → PlantUML
...
| AI SDK | @anthropic-ai/sdk | ^0.20.0 | Claude AI integration |
